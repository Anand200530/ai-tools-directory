...
const tools = [
    ...
    {id: 66, name: "Recraft", category: "design", icon: "🎨", description: "AI-powered design and illustration tool.", pricing: "Freemium", featured: false, url: "https://recraft.ai"},
    {id: 67, name: "Taskade", category: "productivity", icon: "📋", description: "AI-powered task management and workflows.", pricing: "Freemium", featured: false, url: "https://taskade.com"},
    {id: 68, name: "Mem.ai", category: "productivity", icon: "🧠", description: "AI personal knowledge manager and second brain.", pricing: "Freemium", featured: false, url: "https://mem.ai"},
    {id: 69, name: "Coda AI", category: "productivity", icon: "📊", description: "AI docs, spreadsheets, and workflow automation.", pricing: "Freemium", featured: false, url: "https://coda.io"},
    {id: 70, name: "ClickUp AI", category: "productivity", icon: "✅", description: "AI productivity for teams and projects.", pricing: "Freemium", featured: false, url: "https://clickup.com"},
    {id: 71, name: "Motion", category: "productivity", icon: "⚙️", description: "AI calendar and smart scheduler.", pricing: "Paid", featured: false, url: "https://usemotion.com"},
    {id: 72, name: "Reclaim.ai", category: "productivity", icon: "🛡️", description: "AI calendar automation for teams.", pricing: "Freemium", featured: false, url: "https://reclaim.ai"},
    {id: 73, name: "Clockwise", category: "productivity", icon: "⏰", description: "AI calendar optimization for teams.", pricing: "Freemium", featured: false, url: "https://getclockwise.com"},
    {id: 74, name: "Calendly AI", category: "productivity", icon: "📅", description: "AI meeting scheduling automation.", pricing: "Freemium", featured: false, url: "https://calendly.com"},
    {id: 75, name: "Notion", category: "productivity", icon: "📓", description: "All-in-one workspace with AI features.", pricing: "Freemium", featured: false, url: "https://notion.so"},
    {id: 76, name: "Asana AI", category: "productivity", icon: "📊", description: "AI project management assistant.", pricing: "Freemium", featured: false, url: "https://asana.com"},
    {id: 77, name: "Trello AI", category: "productivity", icon: "📋", description: "AI-powered boards and automation.", pricing: "Freemium", featured: false, url: "https://trello.com"},
    {id: 78, name: "Linear", category: "productivity", icon: "📈", description: "AI-powered issue tracking for software teams.", pricing: "Freemium", featured: false, url: "https://linear.app"},
    {id: 79, name: "Raycast AI", category: "productivity", icon: "⚡", description: "AI-powered launcher for Mac productivity.", pricing: "Free", featured: false, url: "https://raycast.com"},
    {id: 80, name: "Perplexity", category: "research", icon: "🔮", description: "AI search engine with sources and citations.", pricing: "Freemium", featured: true, url: "https://perplexity.ai"},
    {id: 81, name: "Elicit", category: "research", icon: "🔬", description: "AI research assistant for literature review.", pricing: "Freemium", featured: false, url: "https://elicit.org"},
    {id: 82, name: "Consensus", category: "research", icon: "📊", description: "AI search engine for scientific papers.", pricing: "Freemium", featured: false, url: "https://consensus.app"},
    {id: 83, name: "Semantic Scholar", category: "research", icon: "📚", description: "AI-powered academic paper search.", pricing: "Free", featured: false, url: "https://semanticscholar.org"},
    {id: 84, name: "Kimi", category: "research", icon: "🔍", description: "AI search with long context support.", pricing: "Freemium", featured: false, url: "https://kimi.ai"},
    {id: 85, name: "DeepSeek", category: "research", icon: "🧠", description: "Advanced AI reasoning and search engine.", pricing: "Free", featured: false, url: "https://deepseek.com"},
    {id: 86, name: "Grok", category: "research", icon: "🚀", description: "xAI's conversational AI with real-time search.", pricing: "Freemium", featured: false, url: "https://grok.com"},
    {id: 87, name: "ChatGPT Search", category: "research", icon: "💬", description: "AI-powered web search integration.", pricing: "Freemium", featured: false, url: "https://chatgpt.com"},
    {id: 88, name: "Gamma", category: "presentation", icon: "📊", description: "AI presentation and website builder.", pricing: "Freemium", featured: true, url: "https://gamma.app"},
    {id: 89, name: "Tome", category: "presentation", icon: "📖", description: "AI-powered storytelling and presentations.", pricing: "Freemium", featured: false, url: "https://tome.app"},
    {id: 90, name: "Beautiful.ai", category: "presentation", icon: "🎨", description: "AI-powered presentation software.", pricing: "Freemium", featured: false, url: "https://beautiful.ai"},
    {id: 91, name: "SlidesAI", category: "presentation", icon: "✨", description: "AI text-to-presentation generator.", pricing: "Freemium", featured: false, url: "https://slidesai.app"},
    {id: 92, name: "Canva Presentations", category: "presentation", icon: "🎨", description: "AI-assisted presentation design.", pricing: "Freemium", featured: false, url: "https://www.canva.com"},
    {id: 93, name: "Otter.ai", category: "meeting", icon: "🦦", description: "AI meeting notes and transcription.", pricing: "Freemium", featured: true, url: "https://otter.ai"},
    {id: 94, name: "Fireflies.ai", category: "meeting", icon: "🔥", description: "AI meeting assistant and recorder.", pricing: "Freemium", featured: false, url: "https://fireflies.ai"},
    {id: 95, name: "Fathom", category: "meeting", icon: "📊", description: "AI meeting summarizer for Zoom and Teams.", pricing: "Freemium", featured: false, url: "https://fathom.video"},
    {id: 96, name: "Zoom AI", category: "meeting", icon: "🎥", description: "AI Companion for Zoom meetings.", pricing: "Freemium", featured: false, url: "https://zoom.us"},
    {id: 97, name: "Lovable", category: "no-code", icon: "💡", description: "AI app builder for web and mobile apps.", pricing: "Freemium", featured: true, url: "https://lovable.dev"},
    {id: 98, name: "Bolt.new", category: "no-code", icon: "⚡", description: "Full-stack AI development platform.", pricing: "Freemium", featured: true, url: "https://bolt.new"},
    {id: 99, name: "v0.dev", category: "no-code", icon: "🎨", description: "AI UI components generator by Vercel.", pricing: "Freemium", featured: true, url: "https://v0.dev"},
    {id: 100, name: "Galileo AI", category: "no-code", icon: "🌟", description: "AI UI design and prototyping.", pricing: "Freemium", featured: false, url: "https://galileo.ai"},
    {id: 101, name: "Uizard", category: "no-code", icon: "🎯", description: "AI wireframe and UI design tool.", pricing: "Freemium", featured: false, url: "https://uizard.com"},
    {id: 102, name: "Framer", category: "no-code", icon: "📱", description: "AI website builder with responsive design.", pricing: "Freemium", featured: false, url: "https://framer.com"},
    {id: 103, name: "Relume", category: "no-code", icon: "🗺️", description: "AI website sitemap and wireframe builder.", pricing: "Freemium", featured: false, url: "https://relume.io"},
    {id: 104, name: "Vercel AI SDK", category: "coding", icon: "⚡", description: "Build AI-powered applications with Vercel.", pricing: "Free", featured: false, url: "https://vercel.com"},
    {id: 105, name: "LangChain", category: "coding", icon: "🔗", description: "Build applications with LLMs.", pricing: "Free", featured: false, url: "https://langchain.com"},
    {id: 106, name: "LlamaIndex", category: "coding", icon: "📚", description: "Data framework for LLM applications.", pricing: "Free", featured: false, url: "https://llamaindex.ai"},
    {id: 107, name: "Hugging Face", category: "coding", icon: "🤗", description: "ML models and datasets repository.", pricing: "Free", featured: true, url: "https://huggingface.co"},
    {id: 108, name: "Weights & Biases", category: "coding", icon: "📊", description: "ML experiment tracking and visualization.", pricing: "Freemium", featured: false, url: "https://wandb.ai"}
];
...
function showToolModal(id) {
    ...
    if (tool.category === 'image') {
        features = ['Text-to-Image', 'Multiple Styles', 'High Quality', 'Commercial Use'];
    } else if (tool.category === 'writing') {
        features = ['AI Writing', 'Content Types', 'Grammar Check', 'Fast Output'];
    } else if (tool.category === 'video') {
        features = ['AI Video', 'Templates', 'Voiceovers', 'Custom Branding'];
    } else if (tool.category === 'audio') {
        features = ['Voice Gen', 'Multi-Language', 'Emotion Control', 'Studio Quality'];
    } else if (tool.category === 'coding') {
        features = ['Code Completion', 'Bug Detection', 'Multiple Langs', 'Real-Time Help'];
    } else if (tool.category === 'design') {
        features = ['AI Design', 'Templates', 'Brand Kits', 'Export Options'];
    } else if (tool.category === 'productivity') {
        features = ['Automation', 'Collaboration', 'Integrations', 'Analytics'];
    } else if (tool.category === 'research') {
        features = ['Deep Research', 'Citations', 'Summaries', 'Multi-Source'];
    } else if (tool.category === 'presentation') {
        features = ['AI Slides', 'Templates', 'Brand Match', 'Export PPTX'];
    } else if (tool.category === 'meeting') {
        features = ['Transcription', 'Action Items', 'Summaries', 'Searchable'];
    } else if (tool.category === 'no-code') {
        features = ['Visual Building', 'No Coding', 'Fast Deploy', 'Scalable'];
    }
    ...
    html += '<span class="meta-pill meta-web">🌐 Web</span>';
    if (tool.featured) {
        html += '<span class="meta-pill meta-featured">⭐ Featured</span>';
    }
    html += '</div></div>';
    html += '<div class="about-section">';
    html += '<h3 class="section-title">About</h3>';
    ...
    html += '<span class="info-value">' + (tool.pricing === 'Free' ? 'Instant' : 'Account') + '</span>';
    html += '</div>';
    html += '</div>';
